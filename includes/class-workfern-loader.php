...
class WORKFERN_Loader
{
     ...
     * @return array The collection of hooks with the new hook appended.
     */
     ...
     *
     * Loops through all stored actions and filters and registers each one
